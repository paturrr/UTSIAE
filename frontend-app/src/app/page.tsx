  ...
  return (
    <div className="max-w-md mx-auto bg-gray-900/70 border border-gray-800 rounded-2xl shadow-2xl backdrop-blur-xl p-10">
      ...
      <form onSubmit={isRegistering ? handleRegister : handleLogin}>
        ...
        <button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-semibold px-4 py-3 rounded-xl shadow-lg shadow-indigo-900/40 transition">
      ...
      <div className="bg-gray-900/70 border border-gray-800 rounded-2xl p-6 shadow-xl">
        ...
        <form onSubmit={handleCreateTask}>
          <div className="grid grid-cols-1 gap-4">
            ...
            <button type="submit" className="bg-indigo-600 hover:bg-indigo-500 text-white px-5 py-3 rounded-xl font-medium shadow-lg shadow-indigo-900/40 transition">
              Submit Task
            </button>
          </div>
        </form>
            ...
            <div className="mt-6 border-t border-gray-800 pt-4">
              ...
              <div className="mt-4 space-y-2">
                ...
                <button
                  ...
                  className="bg-emerald-500 hover:bg-emerald-400 text-white px-4 py-2 rounded-xl text-sm font-medium disabled:opacity-40 disabled:cursor-not-allowed transition"
                >
                  Add Update
                </button>
              </div>
